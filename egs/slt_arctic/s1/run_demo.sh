...
# ./scripts/submit.sh ${MerlinDir}/src/a_addsamplefeats.py conf/duration_${Voice}.conf

# # ### Step 3: train acoustic model ###
# echo "Step 3: training acoustic model..."
# ./scripts/submit.sh ${MerlinDir}/src/a_addsamplefeats.py conf/acoustic_${Voice}.conf

# echo "Acoustic Model Ready!!"

# ### Step 4: synthesize speech   ###
# echo "Step 4: synthesizing speech..."
# ./scripts/submit.sh ${MerlinDir}/src/a_addsamplefeats.py conf/test_dur_synth_${Voice}.conf
# ./scripts/submit.sh ${MerlinDir}/src/a_addsamplefeats.py conf/test_synth_${Voice}.conf
