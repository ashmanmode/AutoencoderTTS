...
def train_DNN(train_xy_file_list, valid_xy_file_list, \
    ...
    #Ashish Check for Pretraining
    print 'Autoencoder -- Ashish --'
    print do_pretraining   ## change the model based on the state of this variable
    print pretraining_epochs
    print pretraining_lr
...
#    sequential_training = True
    ...
    ##make variables ready for pretraining --Ashish--
    print 'Using Train Set as Pre-Train Set -- Ashish --'
    pretrain_set_x = train_set_x
    n_pretrain_batches = train_set_x.get_value(borrow=True).shape[0]
